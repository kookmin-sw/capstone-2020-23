...
public class adapter_result1 extends RecyclerView.Adapter<adapter_result1.ViewHolder> {
    ...
    adapter_result1(ArrayList<String> list) {
        mData = list ;
    }

    // onCreateViewHolder() - 아이템 뷰를 위한 뷰홀더 객체 생성하여 리턴.
    @Override
    public adapter_result1.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(adapter_result1.ViewHolder holder, int position) {
